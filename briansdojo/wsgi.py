...
import os, sys, site
sys.path.append('/var/envs/briansdojo/lib/python2.7/site-packages')
from unipath import Path
sys.path.append('/var/projects/briansdojo')
os.environ['DJANGO_SETTINGS_MODULE'] = 'briansdojo.settings'
